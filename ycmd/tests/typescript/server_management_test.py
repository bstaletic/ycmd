...
from ycmd.tests.typescript import ( PathToTestFile,
                            IsolatedYcmd,
...
def AssertTypeScriptCompleterServerIsRunning( app, is_running ):
...
def ServerManagement_RestartServer_test( app ):
  filepath = PathToTestFile( 'file2.ts' )
  StartTypeScriptCompleterServerInDirectory( app, filepath )

  AssertTypeScriptCompleterServerIsRunning( app, True )
...
def ServerManagement_CloseServer_Unclean_test( app, *args ):
  StartTypeScriptCompleterServerInDirectory( app, PathToTestFile() )
...
def ServerManagement_StopServerTwice_test( app ):
  ...
  AssertTypeScriptCompleterServerIsRunning( app, False )
