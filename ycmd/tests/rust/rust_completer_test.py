...
def GetCompleter_RAFromUserOption_test( *args) -> None:
...
def GetCompleter_InvalidRustRootFromUser_test( *args) -> None:
  user_options = user_options_store.GetAll().copy(
...
def GetCompleter_WarnsAboutOldConfig_test( logger: NonCallableMagicMock ) -> None:
  user_options = user_options_store.GetAll().copy(
