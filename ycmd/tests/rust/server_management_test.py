...
def AssertRustCompleterServerIsRunning( app: TestApp, is_running: bool ) -> None:
...
@patch( 'ycmd.utils.WaitUntilProcessIsTerminated',
        MockProcessTerminationTimingOut )
def ServerManagement_CloseServer_Unclean_test( wait_until: MagicMock, app: TestApp ) -> None:
