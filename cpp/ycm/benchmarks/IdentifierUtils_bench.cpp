...
public:
  void SetUp( const benchmark::State &state ) {
    ...
    for ( int i = 0; i < state.range( 0 ); ++i ) {
      ...
      tag_file_contents += candidate + "\t/foo\thdjtylghuijihguyktjjytfyuguihjulyufjtrhrjtykuylgui;hjoihugyuftdrjhetjrdyugiuojoiuglytdjrshestjrdykuyh;oijpjugyftrudygu;oijpjhuglytdrsjdyuhgu;hoijhuigyfhjtufdgfhgkjhyfrgtdghjukihugyfjtrdyfhgjuokjijuhytfrdhgfhkjuohghkyjfrhdju;oihugkthful;ijpojihugtfdhjglkojiju<F6>ghdyjgkju;oiohuigykujtdhrytygh;ojiuykjhtrdyugkhiuiuyjghflanguage:C++\n";
    }
